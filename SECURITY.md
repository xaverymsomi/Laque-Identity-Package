...
- Tuma barua pepe kwa: **msomivicent@gmail.com**  
  _Kichwa cha ujumbe (subject):_ `Security Disclosure: laque-identity`
...
- Tafadhali epuka data halisi za mtumiaji kwenye PoC; tumia data ya majaribio.

## Ushawishi wa Mabadiliko (Scope)
- Inahusu maktaba hii (msimbo ndani ya repo hii: NIDA client, KYC scoring, phone/TIN utils, n.k.).
- Masuala ya utekelezaji katika miradi yako binafsi yashughulikiwe kwenye miradi husika.

---

## English (Fallback)

**Project:** vicent/laque-identity  
**Security Contact:** msomivicent@gmail.com

Please **do not open a public issue** for vulnerabilities. Email `msomivicent@gmail.com` with subject `Security Disclosure: laque-identity` including affected versions, environment, a short description, reproduction steps/PoC, impact, and any workaround.

**Response SLA:** acknowledge within **72h**; plan/patch within **7–14 days** depending on severity. We follow **responsible disclosure** and will credit reporters unless you request otherwise.
